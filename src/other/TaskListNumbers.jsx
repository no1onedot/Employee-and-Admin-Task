    ...
    return (
        <div className='flex mt-10 screen justify-between gap-5' >
            <div className=' w-[45%] bg-red-400 px-9 py-6 rounded-xl'>
                <h2 className='text-3l font-semibold'>{data.taskNumber.newTask}</h2>
                <h3 className='text-xl font-medium'> New Task</h3>
            </div>
            <div className=' w-[45%] bg-blue-400 px-9 py-6 rounded-xl'>
                <h2 className='text-3l font-semibold'>{data.taskNumber.active}</h2>
                <h3 className='text-xl font-medium'> Active Task</h3>
            </div>
            <div className=' w-[45%] bg-green-400 px-9 py-6 rounded-xl'>
                <h2 className='text-3l font-semibold'>{data.taskNumber.completed}</h2>
                <h3 className='text-xl font-medium'>Completed Task</h3>
            </div>
            <div className=' w-[45%] bg-yellow-400 px-9 py-6 rounded-xl'>
                <h2 className='text-3l font-semibold'>{data.taskNumber.failed}</h2>
